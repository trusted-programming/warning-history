...
set y2label "warnings per file" # label for second axis
set terminal png size 2000,1500 enhanced font "Helvetica,20"
set output 'warning-history-per-files.png'
plot "counts.txt" using 1:2 with lines, '' using 1:($2/$3) with lines axis x1y2
